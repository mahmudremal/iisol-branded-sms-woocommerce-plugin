...
class Meta_Boxes {
	...
	public function add_custom_meta_box() {
		...
		foreach ( $screens as $screen ) {
			add_meta_box(
				...
				__( 'Checkout Video Clip', 'iisol-branded-sms-woocommerce-plugin' ),  // Box title
	...
	public function custom_meta_box_html( $post ) {
		...
		if( ! isset( $meta[ 'full_url' ] ) || empty( $meta[ 'full_url' ] ) ) :
			esc_html_e( 'No video uploaded for this order.', 'iisol-branded-sms-woocommerce-plugin' );
			else :
		?>
		<div class="fwp-tabs__container">
			<div class="fwp-tabs__wrap">
				<div class="fwp-tabs__navs">
					<div class="fwp-tabs__nav-item active" data-target="#the-qrcode"><?php esc_html_e( 'Scan Code', 'iisol-branded-sms-woocommerce-plugin' ); ?></div>
					<div class="fwp-tabs__nav-item" data-target="#the-video"><?php esc_html_e( 'Play Video', 'iisol-branded-sms-woocommerce-plugin' ); ?></div>
				</div>
					...
					<div class="fwp-tabs__content" id="the-video">
						<div class="fwp-video-player-wraper">
							<div class="fwp-video-wrap">
								...
								<!-- <a class="fwp-metabox-download-button" href="<?php echo esc_url( $meta['full_url'] ); ?>" download="<?php echo esc_url( $meta['name'] ); ?>"><?php esc_html_e( 'Download this Video', 'iisol-branded-sms-woocommerce-plugin' ); ?></a> -->
							</div>
						</div>
					</div>
				</div>
