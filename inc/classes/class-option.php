...
class Option {
  ...
  private $file;
	...
	protected function setup_hooks() {
		...
		$this->plugin_slug = 'iisol-branded-sms-woocommerce-plugin';
		$this->plugin_name = 'iisol-branded-sms-woocommerce-plugin';
		$this->textdomain = 'iisol-branded-sms-woocommerce-plugin'; // str_replace('_', '-', $plugin_slug);
	...
	public function init() {
		$this->general = (object) wp_parse_args( apply_filters( 'futurewordpress/project/settings/general', [] ), [
			'page_title'					=> __( 'Configuration.', 'iisol-branded-sms-woocommerce-plugin' ),
			'menu_title'					=> __( 'Config', 'iisol-branded-sms-woocommerce-plugin' ),
			'role'								=> 'manage_options',
			'slug'								=> $this->plugin_slug,
			'page_header'					=> __( 'customization page.', 'iisol-branded-sms-woocommerce-plugin' ),
			'page_subheader'			=> __( 'Your setting panel from where you can control and customize.', 'iisol-branded-sms-woocommerce-plugin' ),
			'no_password'					=> __( 'A password is required.', 'iisol-branded-sms-woocommerce-plugin' ),
		] );
	...
	public function add_settings_link( $links ) {
		$settings_link = '<a href="options-general.php?page='.$this->general->slug.'">' . __( 'Settings', 'iisol-branded-sms-woocommerce-plugin' ) . '</a>';
		// array_push( $links, $settings_link );
		$links[] = $settings_link;
		$links[] = '<a href="https://www.fiverr.com/mahmud_remal/" target="_blank">' . __( 'Developer Support', 'iisol-branded-sms-woocommerce-plugin' ) . '</a>';
		return $links;
	}
