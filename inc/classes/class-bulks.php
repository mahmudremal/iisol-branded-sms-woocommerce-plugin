...
class Bulks {
	...
	protected function setup_hooks() {
		$this->args = [
			...
			'column'	=> 'status',
			'options'	=> [
				''       => __( 'All', 'iisol-branded-sms-woocommerce-plugin' ),
				'open'   => __( 'Open', 'iisol-branded-sms-woocommerce-plugin' ),
				'closed' => __( 'Closed', 'iisol-branded-sms-woocommerce-plugin' ),
			]
		];
		/**
	...
	public function manage_posts_columns( $columns ) {
		...
		$columns[ $this->args[ 'column' ] ] = __( 'Status', 'iisol-branded-sms-woocommerce-plugin' );
		return $columns;
	}
	/**
