...
class Widgets_CustomCategory extends \Elementor\Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		wp_register_style( 'listivo-child-widgets', FUTUREWORDPRESS_PROJECT_BRANDEDSMS_BUILD_CSS_URI . '/widgets.css', [], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, FUTUREWORDPRESS_PROJECT_BRANDEDSMS_BUILD_CSS_DIR_PATH . '/widgets.css' ) );
		...
		wp_register_script( 'listivo-child-widgets', FUTUREWORDPRESS_PROJECT_BRANDEDSMS_BUILD_JS_URI . '/widgets.js', [ 'swiper' ], apply_filters( 'futurewordpress/project/filesystem/filemtime', false, FUTUREWORDPRESS_PROJECT_BRANDEDSMS_BUILD_JS_DIR_PATH . '/widgets.js' ), true );
...
futurewordpress-project-scratch-domain
		return __( 'Custom Category Slider', 'iisol-branded-sms-woocommerce-plugin' );
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				...
				'label' => __( 'Content', 'iisol-branded-sms-woocommerce-plugin' ),
		...
		$this->add_control(futurewordpress-project-scratch-domain
			...
			[
				...
				'label' => esc_html__('Display "View All" button', 'iisol-branded-sms-woocommerce-plugin'),
		...
		$this->add_control(
			...
			[
futurewordpress-project-scratch-domain
				'label' => esc_html__('Style', 'iisol-branded-sms-woocommerce-plugin'),

				'type' => Controls_Manager::SELECT,

				'options' => [

					'left' => esc_html__('Left', 'iisol-branded-sms-woocommerce-plugin'),

					'right' => esc_html__('Right', 'iisol-branded-sms-woocommerce-plugin'),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'Heading Text', 'iisol-branded-sms-woocommerce-plugin' ),

				'type'    => Controls_Manager::TEXT,

				'default' => __( 'Heading Text', 'iisol-branded-sms-woocommerce-plugin' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('Show button', 'iisol-branded-sms-woocommerce-plugin'),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('View All Text', 'iisol-branded-sms-woocommerce-plugin'),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'Button Text', 'iisol-branded-sms-woocommerce-plugin' ),

				'type'    => Controls_Manager::TEXT,

				'default' => __( 'View all', 'iisol-branded-sms-woocommerce-plugin' ),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'View all button link', 'iisol-branded-sms-woocommerce-plugin' ),
		...
		$this->add_control(
				...
				[
						...
						'label' => esc_html__('Image', 'iisol-branded-sms-woocommerce-plugin'),
		...
		$this->start_controls_section(
			...
			array(
				...
				'label' => __( 'Slider', 'iisol-branded-sms-woocommerce-plugin' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Category Label', 'iisol-branded-sms-woocommerce-plugin'),

				'type' => Controls_Manager::TEXT,

				'placeholder' => __( 'Title Here', 'iisol-branded-sms-woocommerce-plugin' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Category URL', 'iisol-branded-sms-woocommerce-plugin'),

				'type' => Controls_Manager::TEXT,

				'placeholder' => __( 'Full URL of this category.', 'iisol-branded-sms-woocommerce-plugin' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Background Color', 'iisol-branded-sms-woocommerce-plugin'),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('Category Items', 'iisol-branded-sms-woocommerce-plugin'),
