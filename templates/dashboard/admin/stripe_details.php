...
<div>
  <div class="row">
    ...
    <div class="card card-full-width rounded m-auto to-print-this-card">
        ...
        <div class="row">
          <div class="col-sm-12">  
          <h4 class="mb-3"><?php esc_html_e( 'Invoice', 'iisol-branded-sms-woocommerce-plugin' ); ?>  #<?php echo esc_html( substr( $log->session_id, -20 ) ); ?></h4>
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
          <h5><?php esc_html_e( 'Bill from:', 'iisol-branded-sms-woocommerce-plugin' ); ?></h5>
          <p><?php echo esc_html( $userInfo->meta->first_name . ' ' . $userInfo->meta->last_name ); ?></p>
          <p><?php echo esc_html( ! empty( $userInfo->meta->address1 ) ? $userInfo->meta->address1 : (
            ! empty( $userInfo->meta->address2 ) ? $userInfo->meta->address2 : __( 'Address not available', 'iisol-branded-sms-woocommerce-plugin' )
          ) ); ?><br>
            <?php echo esc_html( $log->customer_email ); ?> </p>
          </div>
          <div class="col-lg-3">
          <h5><?php esc_html_e( 'Bill fromAmount:', 'iisol-branded-sms-woocommerce-plugin' ); ?></h5>
          <h4>$<?php echo esc_html( number_format_i18n( ( $log->amount / 100 ), 2 ) ); ?></h4>
          </div>
          <div class="col-lg-2 text-end">
          <h5><?php esc_html_e( 'Invoice Date', 'iisol-branded-sms-woocommerce-plugin' ); ?></h5>
        ...
        <div class="row">
          ...
          <div class="table-responsive-lg">
              ...
              <thead>
                <tr>
                  <th scope="col"><?php esc_html_e( 'Description', 'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                  <th scope="col"><?php esc_html_e( 'Price', 'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                  <th scope="col"><?php esc_html_e( 'Quantity', 'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                  <th class="text-end" scope="col"><?php esc_html_e( 'Sub-Total', 'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                </tr>
              </thead>
              <tbody>
                <tr>
                ...
                <tr>
                  <td>
                    <h5 class="mb-0"><b><?php esc_html_e( 'Net Amount', 'iisol-branded-sms-woocommerce-plugin' ); ?></b></h5>
                  </td>
                  <td></td>
                  <td></td>
