    ...
    <form id="register-existing-account-wizard" class="mt-3 text-center" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
      ...
      <ul id="top-tab-list" class="p-0 row list-inline">
        <li class="mb-2 col-lg-3 col-md-6 text-start active" id="account">
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Account', 'iisol-branded-sms-woocommerce-plugin' ); ?></span>
          </a>
        </li>
        <li id="social" class="mb-2 col-lg-3 col-md-6 text-start">
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Social', 'iisol-branded-sms-woocommerce-plugin' ); ?></span>
          </a>
        </li>
        <li id="payment" class="mb-2 col-lg-3 col-md-6 text-start">
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Payment', 'iisol-branded-sms-woocommerce-plugin' ); ?></span>
          </a>
        </li>
        <li id="contract" class="mb-2 col-lg-3 col-md-6 text-start">
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Contract', 'iisol-branded-sms-woocommerce-plugin' ); ?></span>
          </a>
        </li>
      </ul>
      <!-- fieldsets -->
      <fieldset class="active">
        <div class="form-card text-start mb-2">
          <div class="row">
            <div class="col-7">
              <h3 class="mb-4"><?php esc_html_e( 'Account & Personal Information:', 'iisol-branded-sms-woocommerce-plugin' ); ?></h3>
            </div>
            <!-- <div class="col-5">
              <h2 class="steps mb-4"><?php esc_html_e( 'Step 1 - 4', 'iisol-branded-sms-woocommerce-plugin' ); ?></h2>
            </div> -->
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Email:', 'iisol-branded-sms-woocommerce-plugin' ); ?> *</label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'First Name:', 'iisol-branded-sms-woocommerce-plugin' ); ?> *</label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Last Name:', 'iisol-branded-sms-woocommerce-plugin' ); ?> *</label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Display Name:', 'iisol-branded-sms-woocommerce-plugin' ); ?>: *</label>
            ...
            <div class="col-md-6">
              <div class="form-group my-1">
                <label class="form-label"><?php esc_html_e( 'Password:', 'iisol-branded-sms-woocommerce-plugin' ); ?> *</label>
            ...
            <div class="col-md-6">
              <div class="form-group my-1">
                <label class="form-label"><?php esc_html_e( 'Confirm Password:', 'iisol-branded-sms-woocommerce-plugin' ); ?> *</label>
                <div class="input-group has-validation">
        ...
        <button type="button" name="next" class="btn btn-primary next action-button float-end" value="Next"><?php esc_html_e( 'Next', 'iisol-branded-sms-woocommerce-plugin' ); ?></button>
      </fieldset>
      <fieldset class="">
        <div class="form-card text-start">
          <div class="row">
            <div class="col-7">
              <h3 class="mb-4"><?php esc_html_e( 'Socials & Connection:', 'iisol-branded-sms-woocommerce-plugin' ); ?></h3>
            </div>
            <div class="col-5">
              <!-- <h2 class="steps mb-4"><?php esc_html_e( 'Step 2 - 4', 'iisol-branded-sms-woocommerce-plugin' ); ?></h2> -->
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <label class="form-label"><?php esc_html_e( 'TikTok Handle:', 'iisol-branded-sms-woocommerce-plugin' ); ?></label>
              <div class="form-group input-group">
                  <span class="input-group-text" id="tiktok-handle">@</span>
                  <input type="text" class="form-control" aria-label="<?php esc_attr_e( 'TikTok Handle:', 'iisol-branded-sms-woocommerce-plugin' ); ?>" aria-describedby="tiktok-handle" name="metadata[tiktok]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->tiktok ); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'YouTube Handle:', 'iisol-branded-sms-woocommerce-plugin' ); ?></label>
                <div class="form-group input-group">
                  <span class="input-group-text" id="youtube-handle">@</span>
                  <input type="text" class="form-control" aria-label="<?php esc_attr_e( 'YouTube Handle:', 'iisol-branded-sms-woocommerce-plugin' ); ?>" aria-describedby="youtube-handle" name="metadata[YouTube_url]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->YouTube_url ); ?>">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Instagram Handle:', 'iisol-branded-sms-woocommerce-plugin' ); ?></label>
                <div class="form-group input-group">
                  <span class="input-group-text" id="instagram-handle">@</span>
                  <input type="text" class="form-control" aria-label="<?php esc_attr_e( 'YouTube Handle:', 'iisol-branded-sms-woocommerce-plugin' ); ?>" aria-describedby="instagram-handle" name="metadata[instagram_url]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->instagram_url ); ?>">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Website Url:', 'iisol-branded-sms-woocommerce-plugin' ); ?></label>
            ...
            <!-- <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Contact No.:', 'iisol-branded-sms-woocommerce-plugin' ); ?> *</label>
                <input type="text" class="form-control" name="metadata[phone]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->phone ); ?>" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Alternate Contact No.:', 'iisol-branded-sms-woocommerce-plugin' ); ?></label>
                <input type="text" class="form-control" name="metadata[phone1]" value="<?php echo esc_attr( $userInfo->meta->phone1 ); ?>" placeholder="">
              </div>
            </div> -->
            <div class="col-md-12">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Address Line 1:', 'iisol-branded-sms-woocommerce-plugin' ); ?></label>
                <input type="text" class="form-control" name="metadata[address1]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->address1 ); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Address Line 2:', 'iisol-branded-sms-woocommerce-plugin' ); ?></label>
                <input type="text" class="form-control" name="metadata[address2]" value="<?php echo esc_attr( $userInfo->meta->address2 ); ?>" placeholder="">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label" for="choices-single-default"><?php esc_html_e( 'Country:', 'iisol-branded-sms-woocommerce-plugin' ); ?></label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'City:', 'iisol-branded-sms-woocommerce-plugin' ); ?></label>
                <input type="text" class="form-control" name="metadata[city]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->city ); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'State:', 'iisol-branded-sms-woocommerce-plugin' ); ?></label>
                <input type="text" class="form-control" name="metadata[state]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->state ); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Zip Code:', 'iisol-branded-sms-woocommerce-plugin' ); ?></label>
        ...
        <button type="button" name="next" class="btn btn-primary next action-button float-end" value="Next"><?php esc_html_e( 'Next', 'iisol-branded-sms-woocommerce-plugin' ); ?></button>
        <button type="button" name="previous" class="btn btn-dark previous action-button-previous float-end me-1" value="Previous"><?php esc_html_e( 'Previous', 'iisol-branded-sms-woocommerce-plugin' ); ?></button>
      </fieldset>
      <fieldset class="">
        <div class="form-card text-start">
          <div class="row">
            <div class="col-7">
              <h3 class="mb-4"><?php esc_html_e( 'Payment:', 'iisol-branded-sms-woocommerce-plugin' ); ?></h3>
              <!-- <h3 class="mb-4"><?php esc_html_e( 'Image Upload:', 'iisol-branded-sms-woocommerce-plugin' ); ?></h3> -->
            </div>
            <div class="col-5">
              <!-- <h2 class="steps mb-4"><?php esc_html_e( 'Step 3 - 4', 'iisol-branded-sms-woocommerce-plugin' ); ?></h2> -->
            </div>
          </div>
          <div class="row">
                ...
                <div class="card rounded-3">
                  <div class="card-body mx-1 my-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <p class="d-flex flex-column mb-0">
                          <b><?php esc_html_e( 'Pay to proceed on contract.', 'iisol-branded-sms-woocommerce-plugin' ); ?></b>
                        </p>
                      </div>
                    </div>
                      ...
                      <div class="d-flex flex-row pb-3">
                        <div class="rounded border border-primary border-2 d-flex w-100 p-3 align-items-center"
                          ...
                          <div class="d-flex flex-column">
                            <p class="mb-1 small text-primary"><?php esc_html_e( 'Monthly Retainer', 'iisol-branded-sms-woocommerce-plugin' ); ?></p>
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-1">
                      <!-- <a href="<?php echo esc_url( site_url( 'pay_retainer/' . $userInfo->ID . '/' ) ); ?>" class="btn btn-primary btn-lg pay_retainer-amount" target="_blank"><?php esc_html_e( 'Pay amount',   'iisol-branded-sms-woocommerce-plugin' ); ?></a> -->
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!-- <div class="col-sm-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Upload Your Photo:', 'iisol-branded-sms-woocommerce-plugin' ); ?></label>
        ...
        <!-- <a type="button" href="<?php echo esc_url( site_url( 'pay_retainer/' . $userInfo->ID . '/' ) ); ?>" target="_blank" name="pay-amount" class="btn btn-primary next action-button float-end" value="Submit"><?php esc_html_e( 'Pay Amount', 'iisol-branded-sms-woocommerce-plugin' ); ?></a> -->
        <button type="submit" name="submit" class="btn btn-primary next action-button float-end" value="Submit"><?php esc_html_e( 'Submit', 'iisol-branded-sms-woocommerce-plugin' ); ?></button>
        <button type="button" name="previous" class="btn btn-dark previous action-button-previous float-end me-1" value="Previous"><?php esc_html_e( 'Previous', 'iisol-branded-sms-woocommerce-plugin' ); ?></button>
      </fieldset>
      <fieldset class="">
        <div class="form-card">
          <div class="row">
            <div class="col-7">
              <h3 class="mb-4 text-left"><?php esc_html_e( 'Finish:', 'iisol-branded-sms-woocommerce-plugin' ); ?></h3>
            </div>
            <div class="col-5">
              <!-- <h2 class="steps mb-4"><?php esc_html_e( 'Step 4 - 4', 'iisol-branded-sms-woocommerce-plugin' ); ?></h2> -->
            </div>
          </div>
          <br>
          <br>
          <h2 class="text-center text-success">
            <strong><?php esc_html_e( 'SUCCESS !', 'iisol-branded-sms-woocommerce-plugin' ); ?></strong>
          </h2>
          <br>
          <div class="row justify-content-center">
            <div class="col-3">
              <img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_BRANDEDSMS_BUILD_URI . '/img/img-success.png' ); ?>" class="img-fluid" alt="fit-image" loading="lazy">
            </div>
          </div>
          <br>
          <br>
          <div class="row justify-content-center">
            <div class="text-center col-7">
              <h5 class="text-center purple-text"><?php esc_html_e( 'You Have Successfully Signed Up', 'iisol-branded-sms-woocommerce-plugin' ); ?></h5>
            </div>
          </div>
        </div>
      </fieldset>
