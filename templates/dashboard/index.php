...
if( empty( $user_profile ) || $user_profile == 0 ) {
  wp_die( __( 'You\'ve visited on an outdated link, or your link is no longer valid. We didn\'t idetify the user with this permalink. That\'s all we know', 'iisol-branded-sms-woocommerce-plugin' ), __( 'Link broken', 'iisol-branded-sms-woocommerce-plugin' ) );
}
if( $user_profile == 'me' ) {
...
if( is_wp_error( $userInfo ) || $errorHappens ) :
  ...
  wp_die( $errorHappens, __( 'Error Happens', 'iisol-branded-sms-woocommerce-plugin' ) );
else :
  ...
  add_filter( 'pre_get_document_title', function( $title ) {
    global $userInfo;
    $title = apply_filters( 'futurewordpress/project/system/getoption', 'dashboard-title', __( 'User Dashbord', 'iisol-branded-sms-woocommerce-plugin' ) );
    $title = str_replace( [
      '{username}', '{sitename}'
    ], [
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between">
              ...
              <ul class="d-flex nav nav-pills mb-0 text-center profile-tab nav-slider" data-toggle="slider-tab" id="profile-pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-profile" role="tab" aria-selected="true" tabindex="-1"><?php esc_html_e( 'Profile',   'iisol-branded-sms-woocommerce-plugin' ); ?></a>
                </li>
                <?php endif; ?>
                <?php if( in_array( 'archive', $allowedTabs ) ) : ?>
                <li class="nav-item" role="presentation">
                  <a class="nav-link active show" data-bs-toggle="tab" href="#profile-archive" role="tab" aria-selected="false"><?php esc_html_e( 'Submit Videos',   'iisol-branded-sms-woocommerce-plugin' ); ?></a>
                </li>
                <?php endif; ?>
                <?php if( in_array( 'payments', $allowedTabs ) ) : ?>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-payments" role="tab" aria-selected="false" tabindex="-1"><?php esc_html_e( 'Payments',   'iisol-branded-sms-woocommerce-plugin' ); ?></a>
                </li>
                <?php endif; ?>
                <?php if( in_array( 'settings', $allowedTabs ) ) : ?>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-settings" role="tab" aria-selected="false" tabindex="-1"><?php esc_html_e( 'Your Social Media Handles',   'iisol-branded-sms-woocommerce-plugin' ); ?></a>
                </li>
                <?php endif; ?>
                <?php if( in_array( 'contact', $allowedTabs ) && apply_filters( 'futurewordpress/project/system/isactive', 'social-contact' ) ) : ?>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" data-bs-toggle="tab" href="#profile-contact" role="tab" aria-selected="false" tabindex="-1"><?php esc_html_e( 'Contact us now!',   'iisol-branded-sms-woocommerce-plugin' ); ?></a>
                </li>
                <?php endif; ?>
              </ul>
              <a href="<?php echo wp_logout_url(); ?>" class="btn btn-soft-danger btn-logout-confirm nav-link nav nav-pills mb-0 text-center profile-tab nav-slider"><?php esc_html_e( 'Logout', 'iisol-branded-sms-woocommerce-plugin' ); ?></a>
            </div>
          </div>
        </div>
      </div>
      <?php include FUTUREWORDPRESS_PROJECT_BRANDEDSMS_DIR_PATH . '/templates/dashboard/cards/notices.php'; ?>
      <div class="col-lg-3">
        <div class="card h-12">
          <div class="card-header">
          <div class="header-title">
            <h4 class="card-title"><?php esc_html_e( 'Overview',   'iisol-branded-sms-woocommerce-plugin' ); ?></h4>
          </div>
          </div>
          <div class="card-body">
            ...
            <div class="text-center m-auto">
              <h4><?php esc_html_e( 'Monthly Retainer', 'iisol-branded-sms-woocommerce-plugin' ); ?></h4>
            ...
            <p class="mt-4 text-center"><strong style="margin-right: 5px;"><?php esc_html_e( 'Joined:',   'iisol-branded-sms-woocommerce-plugin' ); ?></strong> <?php echo esc_html( wp_date( 'M d, Y', strtotime( $userInfo->data->user_registered ) ) ); ?></p>
            ...
            <p class="mt-4 text-center"><strong style="margin-right: 5px;"><?php esc_html_e( 'Next Retainer:',   'iisol-branded-sms-woocommerce-plugin' ); ?></strong> <?php echo esc_html( wp_date( 'M d, Y', (int) $subsc[ 'current_period_end' ] ) ); ?></p>
            <?php endif; ?>
            <div class="separator separator-dashed my-8"></div>
            <?php endif; ?>
            ...
            <ul class="list-inline m-0 p-0">
              ...
              <img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_BRANDEDSMS_BUILD_URI . '/icons/calendar-checklist-date-svgrepo-com.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border bg-soft-light img-fluid" loading="lazy">
                <div class="ms-3">
                  <a class="" href="<?php echo empty( $userInfo->meta->content_calendar ) ? esc_attr( 'javascript:void(0)' ) : esc_url( $userInfo->meta->content_calendar ); ?>" target="<?php echo esc_attr( empty( $userInfo->meta->content_calendar ) ? '_self' : '_blank' ); ?>">
                    <h5><?php esc_html_e( 'Content Calendar',   'iisol-branded-sms-woocommerce-plugin' ); ?></h5>
              ...
              <li class="d-flex mb-4 align-items-center">
                ...
                <img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_BRANDEDSMS_BUILD_URI . '/icons/bookshelf-svgrepo-com.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-soft-danger" loading="lazy">
                <div class="ms-3">
                  <a class="" href="<?php echo empty( $userInfo->meta->content_library ) ? esc_attr( 'javascript:void(0)' ) : esc_url( $userInfo->meta->content_library ); ?>" target="<?php echo esc_attr( empty( $userInfo->meta->content_library ) ? '_self' : '_blank' ); ?>">
                    <h5><?php esc_html_e( 'Content Library',   'iisol-branded-sms-woocommerce-plugin' ); ?></h5>
                    <!-- <p class="mb-0">Added 1 hour ago</p> -->
                  </a>
                </div>
              </li>
              ...
              <li class="d-flex mb-4 align-items-center position-relative">
                <img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_BRANDEDSMS_BUILD_URI . '/icons/contract-document-svgrepo-com.svg' ); ?>" data-img="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_BRANDEDSMS_BUILD_URI . '/icons/Information carousel_Monochromatic.svg' ); ?>" alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-soft-danger" loading="lazy">
                <?php if( $doc->document_status != 'signed' ) : ?>
                  <span class="badge border border-danger bg-danger" style="position: absolute;top: -10px;left: 30px;color: black;"><?php esc_html_e( 'Action Needed',   'iisol-branded-sms-woocommerce-plugin' ); ?></span>
                <?php endif; ?>
                <div class="ms-3">
                  <a class="" href="<?php echo esc_url( $doc->permalink ); ?>" target="_blank">
                    <h5><?php echo esc_html( ( $doc->document_status == 'signed' ) ? __( 'Document Signed',   'iisol-branded-sms-woocommerce-plugin' ) : __( 'Sign Document',   'iisol-branded-sms-woocommerce-plugin' ) ); ?></h5>
                    <!-- <p class="mb-0">Added 1 hour ago</p> -->
                  </a>
                </div>
              </li>
        ...
        <div class="card h-12 profile-content tab-content iq-tab-fade-up">
          ...
          <div id="profile-profile" class="tab-pane fade" role="tabpanel">
            ...
            <div class="card">
              <div class="card-header">
                <div class="header-title">
                  <h4 class="card-title"><?php echo esc_html( sprintf( __( 'About %s',   'iisol-branded-sms-woocommerce-plugin' ), $userInfo->data->display_name ) ); ?></h4>
                </div>
              </div>
              <div class="card-body">
                ...
                <div class="mt-2">
                  <h6 class="mb-1"><?php esc_html_e( 'Joined:',   'iisol-branded-sms-woocommerce-plugin' ); ?></h6>
                  <p> <?php echo esc_html( wp_date( 'M d, Y', strtotime( $userInfo->data->user_registered ) ) ); ?></p>
                </div>
                <div class="mt-2">
                <h6 class="mb-1"><?php esc_html_e( 'Lives:',   'iisol-branded-sms-woocommerce-plugin' ); ?></h6>
                ...
                <div class="mt-2">
                <h6 class="mb-1"><?php esc_html_e( 'Email:',   'iisol-branded-sms-woocommerce-plugin' ); ?></h6>
                ...
                <div class="mt-2">
                <h6 class="mb-1"><?php esc_html_e( 'Url:',   'iisol-branded-sms-woocommerce-plugin' ); ?></h6>
                ...
                <div class="mt-2">
                <h6 class="mb-1"><?php esc_html_e( 'Contact:',   'iisol-branded-sms-woocommerce-plugin' ); ?></h6>
          ...
          <div id="profile-archive" class="tab-pane fade active show" role="tabpanel">
            <div class="card">
              <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                  <h4 class="card-title"><?php esc_html_e( 'Client Raw Video Archive',   'iisol-branded-sms-woocommerce-plugin' ); ?></h4>
                </div>
              </div>
              <div class="card-body">
                <div class="border rounded mb-3 p-2">
                  <form id="the-raw-video-archive-upload" class="form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <select class="form-select form-select-lg form-select-solid mb-2" name="month" data-control="select2" data-placeholder="<?php esc_attr_e( 'Upload for...', 'iisol-branded-sms-woocommerce-plugin' ); ?>">
                      ...
                      <div class="col-md-6">
                        <select class="form-select form-select-lg form-select-solid mb-2" name="year" data-control="select2" data-placeholder="<?php esc_attr_e( 'Upload for...', 'iisol-branded-sms-woocommerce-plugin' ); ?>">
                      ...
                      <div class="com-md-12">
                        <button type="button" class="btn btn-light-primary fw-bold col-12 mt-3 submit-archive-files" data-config="<?php echo esc_attr( json_encode( [
                          'title' => __( 'A short title', 'iisol-branded-sms-woocommerce-plugin' ),
                          'text' => __( 'Choose a title for your monthly archive. To update your archive, simply re-upload your files and resubmit - the new files will replace the previous ones.', 'iisol-branded-sms-woocommerce-plugin' ),
                          'icon' => 'info',
                          'confirmButtonText' => __( 'Submit', 'iisol-branded-sms-woocommerce-plugin' ),
                          'input' => 'text',
                          'inputAttributes' => [
                            'autocapitalize' => 'off'
                          ],
                        ...
                        ] ) ); ?>" role="button"><?php esc_html_e( 'Submit & Upload', 'iisol-branded-sms-woocommerce-plugin' ); ?></button>
                      </div>
                    </div>
                  </form>
                </div>
                ...
                <div class="<?php echo esc_attr( ( count( $archives ) > 0 ) ? 'custom-table-effect' : '' ); ?> table-responsive  border rounded">
                  <table class="table mb-0 fwp-datatable-field" data-toggle="data-table">
                    <thead>
                      <tr class="bg-white">
                        <th scope="col"><?php esc_html_e( 'Uploaded time',   'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                        <th scope="col"><?php esc_html_e( 'Attached title',   'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                        <th scope="col"><?php esc_html_e( 'Download',   'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                      </tr>
                    </thead>
                    <tbody>
                    <?php if( count( $archives ) <= 0 ) : ?>
                        <tr>
                          <td colspan="3"><img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_BRANDEDSMS_BUILD_URI . '/icons/undraw_file_bundle_re_6q1e.svg' ); ?>" alt="<?php esc_attr_e( 'No Archives',   'iisol-branded-sms-woocommerce-plugin' ); ?>"></td>
                        </tr>
                      <?php else : ?>
          ...
          <div id="profile-payments" class="tab-pane fade" role="tabpanel">
            ...
            <?php if( false && apply_filters( 'futurewordpress/project/system/isactive', 'stripe-cancelsubscription' ) ) : ?>
              <div class="col-lg-6 col-md-6">
                <div class="card text-center">
                  <div class="card-body payment-page-card">
                    <h3 class=""><?php esc_html_e( 'Pause Subscription',   'iisol-branded-sms-woocommerce-plugin' ); ?></h3>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="card text-center">
                  <div class="card-body payment-page-card">
                    <h3 class=""><?php esc_html_e( 'Subscription',   'iisol-branded-sms-woocommerce-plugin' ); ?></h3>
                    ...
                    ] ) ); ?>" data-userid="<?php echo esc_html( $userInfo->ID ); ?>"><?php esc_html_e( 'Cancel', 'iisol-branded-sms-woocommerce-plugin' ); ?></button>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between">
                <div class="header-title pause-unpause-subscription-wrap">
                  <h4 class="card-title"><?php esc_html_e( 'Payment History',   'iisol-branded-sms-woocommerce-plugin' ); ?></h4>
                  ...
                  <?php if( ! apply_filters( 'futurewordpress/project/system/isactive', 'stripe-cancelsubscription' ) ) : ?>
                    <?php
                      ...
                      $config = [
                        'popup_title'       => __( 'Enter payment card details', 'iisol-branded-sms-woocommerce-plugin' ),
                        'card_number'       => __( 'Card Number:', 'iisol-branded-sms-woocommerce-plugin' ),
                        'expire_month'      => __( 'Expiration month:', 'iisol-branded-sms-woocommerce-plugin' ),
                        'expire_year'       => __( 'Expiration year:', 'iisol-branded-sms-woocommerce-plugin' ),
                        'card_ccv'          => __( 'CVC:', 'iisol-branded-sms-woocommerce-plugin' ),
                        'pls_fillall'       => __( 'Please fillup all fields first.', 'iisol-branded-sms-woocommerce-plugin' ),
                        'pls_fixwrngcdnm'   => __( 'Seems you\'ve inputed a wrong card number', 'iisol-branded-sms-woocommerce-plugin' ),
                        'pls_fillmonth'          => __( 'Please input Month in numeric format', 'iisol-branded-sms-woocommerce-plugin' ),
                        'pls_fixyear'          => __( 'Card expiration year should be future date.', 'iisol-branded-sms-woocommerce-plugin' ),
                        'pls_fixccv'          => __( 'Please provide valid CVC number.', 'iisol-branded-sms-woocommerce-plugin' ),
                      ];
                    ?>
                    <div class="btn-group btn-group-sm">
                      <button class="btn btn-soft-success border-active change-payment-card" type="button" role="button" name="change-payment-card" data-config="<?php echo esc_attr( json_encode( $config ) ); ?>" data-userid="<?php echo esc_attr( $userInfo->ID ); ?>"><?php esc_html_e( 'Change Payment Card',   'iisol-branded-sms-woocommerce-plugin' ); ?></button>
                      <button class="pause-unpause-subscription btn <?php echo esc_attr( $is_pending ? 'btn-light' : ( $is_active ? 'btn-outline-warning border-active' : 'btn-primary' ) ); ?>" type="button" role="button" name="meta-enable_subscription" data-current="<?php echo esc_attr( $is_active ? ( ( $dida_pause && $is_active ) ? 'pending' : 'pause' ) : 'unpause' ); ?>" data-pause-title="<?php esc_attr_e( 'Pause My Retainer', 'iisol-branded-sms-woocommerce-plugin' ); ?>" data-unpause-title="<?php esc_attr_e( 'Resume My Retainer', 'iisol-branded-sms-woocommerce-plugin' ); ?>" data-pending-title="<?php esc_attr_e( 'Pending', 'iisol-branded-sms-woocommerce-plugin' ); ?>" <?php echo esc_attr( $is_pending ? 'data-handled=true disabled' : '' ); ?>>
                        <?php echo esc_html( $is_pending ? __( 'Pending', 'iisol-branded-sms-woocommerce-plugin' ) : ( $is_active ? __( 'Pause My Retainer', 'iisol-branded-sms-woocommerce-plugin' ) : __( 'Resume My Retainer', 'iisol-branded-sms-woocommerce-plugin' ) ) ); ?>
                      </button>
                    </div>
                    <?php endif; ?>
                </div>
              ...
              <div class="card-body">
                ...
                <div class="<?php echo esc_attr( ( count( $payments[ 'data' ] ) > 0 ) ? 'custom-table-effect' : '' ); ?> table-responsive  border rounded">
                  <table class="table mb-0 fwp-datatable-field" data-toggle="data-table">
                    <thead>
                      <tr class="bg-white">
                        <th><?php esc_html_e( 'Name',   'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                        <th><?php esc_html_e( 'Email',   'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                        <th><?php esc_html_e( 'Date',   'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                        <th><?php esc_html_e( 'Currency',   'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                        <th><?php esc_html_e( 'Amount',   'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                        <th><?php esc_html_e( 'Status',   'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                        <th><?php esc_html_e( 'Invoice',   'iisol-branded-sms-woocommerce-plugin' ); ?></th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php if( count( $payments[ 'data' ] ) <= 0 ) : ?>
                        <tr>
                          <td colspan="7"><img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_BRANDEDSMS_BUILD_URI . '/icons/Card Payment_Monochromatic.svg' ); ?>" alt="<?php esc_attr_e( 'No Payments',   'iisol-branded-sms-woocommerce-plugin' ); ?>"></td>
                        </tr>
                      <?php else : ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo esc_html( ( $pay[ 'paid' ] ) ? __( 'Paid', 'iisol-branded-sms-woocommerce-plugin' ) : __( 'Unpaid', 'iisol-branded-sms-woocommerce-plugin' ) ); ?></td>
                          <td>
                            <div class="d-flex justify-content-evenly">
          ...
          <div id="profile-settings" class="tab-pane fade" role="tabpanel">
            <div class="card">
              <div class="card-header">
                <div class="header-title">
                <h4 class="card-title"><?php esc_html_e( 'Profile Settings',   'iisol-branded-sms-woocommerce-plugin' ); ?></h4>
                </div>
              </div>
              <div class="card-body">
                <?php include FUTUREWORDPRESS_PROJECT_BRANDEDSMS_DIR_PATH . '/templates/dashboard/cards/content.php'; ?>
              </div>
            </div>
          </div>
          <?php endif; ?>
          ...
          <div id="profile-contact" class="tab-pane fade" role="tabpanel">
            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                  <h4 class="card-title"><?php esc_html_e( 'Contact us now!',   'iisol-branded-sms-woocommerce-plugin' ); ?></h4>
                </div>
              </div>
              <div class="card-body">
                      ...
                      <a class="card-body" href="<?php echo esc_url( apply_filters( 'futurewordpress/project/system/getoption', 'social-telegram', false ) ); ?>" target="_blank">
                        <div class="d-block justify-content-between align-items-center">
                          ...
                          <div class="text-center mt-3">
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'Telegram',   'iisol-branded-sms-woocommerce-plugin' ); ?></h3>
                          </div>
                        </div>
                      </a>
                    </div>
                    ...
                    <div class="card bg-soft-warning">
                      <a class="card-body" href="<?php echo esc_url( apply_filters( 'futurewordpress/project/system/getoption', 'social-whatsapp', false ) ); ?>" target="_blank">
                        <div class="d-block justify-content-between align-items-center">
                          ...
                          <div class="text-center mt-3">
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'WhatsApp',   'iisol-branded-sms-woocommerce-plugin' ); ?></h3>
                          </div>
                        </div>
                      </a>
                    </div>
                    ...
                    <div class="card bg-soft-warning">
                      <a class="card-body" href="mailto:<?php echo esc_attr( apply_filters( 'futurewordpress/project/system/getoption', 'social-email', false ) ); ?>">
                        <div class="d-block justify-content-between align-items-center">
                          ...
                          <div class="text-center mt-3">
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'Email',   'iisol-branded-sms-woocommerce-plugin' ); ?></h3>
                          </div>
                        </div>
                      </a>
                    </div>
                  ...
                  <div class="col-lg-12 col-md-12">
                    <div class="card">
                      <a class="card-body" href="<?php echo esc_url( apply_filters( 'futurewordpress/project/system/getoption', 'social-contactus', false ) ); ?>" target="_blank">
                        <div class="d-block justify-content-between align-items-center">
                          <div class="rounded p-3 text-center">
                            <img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_BRANDEDSMS_BUILD_URI . '/icons/Team meeting_Monochromatic.svg' ); ?>" alt="Contact Us" height="" width="">
                          </div>
                          <div class="text-center mt-3">
                            <h3 class="counter" style="visibility: visible;"><?php esc_html_e( 'Contact US',   'iisol-branded-sms-woocommerce-plugin' ); ?></h3>
                          </div>
                        </div>
                      </a>
                    </div>
...
<div class="d-flex flex-column flex-root">
  ...
  <div class="wrapper d-flex flex-column flex-row-fluid">
    ...
    <?php // include FUTUREWORDPRESS_PROJECT_BRANDEDSMS_DIR_PATH . '/templates/dashboard/cards/toolbar.php'; ?>
    ...
    <?php // include FUTUREWORDPRESS_PROJECT_BRANDEDSMS_DIR_PATH . '/templates/dashboard/cards/footer.php'; ?>
    
    </div>
  </div>

  <?php // include FUTUREWORDPRESS_PROJECT_BRANDEDSMS_DIR_PATH . '/templates/dashboard/cards/sidebar.php'; ?>
